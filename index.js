...
function playWrongSound() {
  var wrongAudio = new Audio("sounds/closing.mp3");
  wrongAudio.play();
}

// function playWrongSound(randomWrongSound) {
//   var wrongAudio = new Audio("sounds/ + randomWrongSound +.mp3");
//   wrongAudio.play();
// }
